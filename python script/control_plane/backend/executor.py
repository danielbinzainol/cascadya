...
from backend.config import WSL_DISTRO
...
class ShellExecutor:
    def __init__(self, use_wsl: bool | None = None, wsl_distro: str = WSL_DISTRO) -> None:
    ...
    def run(
        ...
        try:
            ...
            return CommandResult(command=command, return_code=1, duration_seconds=0.0)
        ...
        return CommandResult(command=command, return_code=return_code, duration_seconds=duration)
