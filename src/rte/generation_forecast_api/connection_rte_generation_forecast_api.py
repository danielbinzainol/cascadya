...
from src.rte.generation_forecast_api.rte_generation_forecast_client import (
    ...
    RteGenerationForecastApiError,
    RteGenerationForecastAuthConfig,
    RteGenerationForecastAuthError,
...
async def get_rte_generation_forecasts(
    ...
    auth_config = RteGenerationForecastAuthConfig(
    ...
    except RteGenerationForecastAuthError as exc:
        raise HTTPException(status_code=401, detail=str(exc)) from exc
    except RteGenerationForecastApiError as exc:
