...
DATA_DIR = Path(r'D:\\Cascadya\\Cascadya - Documents\\10. IT\\5. Script Faisa\\Equilibrage 2025')
...
def build_df_all():
    ...
    file_index_df = pd.DataFrame(file_index).sort_values('first_timestamp').reset_index(drop=True)
