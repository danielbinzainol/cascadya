...
from src.rte.generation_forecast_api.rte_generation_forecast_client import RteGenerationForecastAuthError
...
def test_generation_forecast_endpoint_maps_auth_error(monkeypatch) -> None:
    class FakeRteGenerationForecastClient:
        ...
        async def get_forecasts(self, *, production_types, forecast_types, start_date, end_date):  # noqa: ANN001
            _ = (production_types, forecast_types, start_date, end_date)
            raise RteGenerationForecastAuthError("invalid token", status_code=401)
